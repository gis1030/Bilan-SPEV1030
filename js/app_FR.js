...
map.attributionControl.setPrefix('©GeoData1030: geodata.gis1030@gmail.com <a href="https://www.1030.be/" target="_blank" >Commune de Schaerbeek</a> &middot; <a href="https://github.com/tomchadwin/qgis2web" target="_blank">qgis2web</a> &middot; <a href="https://leafletjs.com" title="A JS library for interactive maps">Leaflet</a> &middot; <a href="https://qgis.org">QGIS</a>');
...
let title = new L.Control({ 'position': 'topleft' });
...
title.update = function () {
    this._div.innerHTML = '<h2>Novembre 2025. Actions de propreté publique <br>du service communal de Schaerbeek.</h2>';
};
title.addTo(map);

let abstract = new L.Control({ 'position': 'topleft' });
...
let layer_GoogleSatellite_0 = L.tileLayer('http://mt0.google.com/vt/lyrs=s&hl=en&x={x}&y={y}&z={z}', {
...
let layer_GoogleTerrain_1 = L.tileLayer('http://mt0.google.com/vt/lyrs=p&hl=en&x={x}&y={y}&z={z}', {
...
let layer_LimitesSchaerbeekQuartiers_2 = new L.geoJson(json_LimitesSchaerbeekQuartiers_2, {
    attribution: '',
    interactive: true,
...
let layer_LimitesSchaerbeek_3 = new L.geoJson(json_LimitesSchaerbeek_3, {
    attribution: '',
    interactive: true,
...
const style_Rodenbach_4_0 = StyleFactory.create({
    property: 'SOUS_SECTOR',
    default: {
    ...
    styles: {
        'Rodenbach01': { fillColor: 'rgba(120,162,202,1.0)' },
        'Rodenbach02': { fillColor: 'rgba(201,151,105,1.0)' },
        'Rodenbach03': { fillColor: 'rgba(219,81,224,1.0)' }
    }
});
...
let layer_Rodenbach_4 = new L.geoJson(json_Rodenbach_4, {
    attribution: '',
    interactive: true,
...
let layer_Radium_5 = new L.geoJson(json_Radium_5, {
    attribution: '',
    interactive: true,
...
let layer_Vifquin_6 = new L.geoJson(json_Vifquin_6, {
    attribution: '',
    interactive: true,
...
let layer_LimitesSecteursSPEV_7 = new L.geoJson(json_LimitesSecteursSPEV_7, {
    attribution: '',
    interactive: true,
...
function pop_DecheterieMobile_8(feature, layer) {
    ...
    let popupContent = '<table>\
                    ...
                    <tr>\
                        <th scope="row">nombre de balayage</th>\
                        <td>' + (feature.properties['Total Balayage'] !== null ? autolinker.link(String(feature.properties['Total Balayage']).replace(/'/g, '\'').toLocaleString()) : '') + '</td>\
                    </tr>\
                    <tr>\
...
let layer_DecheterieMobile_8 = new L.geoJson(json_SPEVBilan2025, {
    attribution: '',
    interactive: true,
...
function style_Taxe_9_0(feature) {
    ...
    if (feature.properties['Total Taxe'] >= 15.000000) {
        return {
            pane: 'pane_Taxe_9',
            radius: 18,
            opacity: 1,
...
let layer_Taxe_9 = new L.geoJson(json_SPEVBilan2025, {
    attribution: '',
    interactive: true,
    dataVar: 'SPEVBilan2025',
...
function style_MoyenneBalayage_10_0(feature) {
    if (feature.properties['Total Balayage'] == 0.000000) {
        return {
    ...
    if (feature.properties['Total Balayage'] >= 1.000000 && feature.properties['Total Balayage'] <= 10.000000) {
        return {
            pane: 'pane_MoyenneBalayage_10',
            radius: 2.0,
            opacity: 1,
    ...
    if (feature.properties['Total Balayage'] >= 10.000000 && feature.properties['Total Balayage'] <= 15.000000) {
        return {
            pane: 'pane_MoyenneBalayage_10',
            radius: 5.5,
            opacity: 1,
    ...
    if (feature.properties['Total Balayage'] >= 15.000000 && feature.properties['Total Balayage'] <= 20.000000) {
        return {
            pane: 'pane_MoyenneBalayage_10',
            radius: 9.0,
            opacity: 1,
    ...
    if (feature.properties['Total Balayage'] >= 20.000000 && feature.properties['Total Balayage'] <= 50.000000) {
        return {
            pane: 'pane_MoyenneBalayage_10',
            radius: 12.5,
            opacity: 1,
    ...
    if (feature.properties['Total Balayage'] >= 50.000000 && feature.properties['Total Balayage'] <= 5000.000000) {
        return {
            pane: 'pane_MoyenneBalayage_10',
            radius: 16.0,
            opacity: 1,
...
let layer_MoyenneBalayage_10 = new L.geoJson(json_SPEVBilan2025, {
    attribution: '',
    interactive: true,
    dataVar: 'SPEVBilan2025',
...
function style_Mediation_11_0(feature) {
    ...
    if (feature.properties['Total Mediation'] >= 1) {
        return {
            pane: 'pane_Mediation_11',
            radius: 8,
            opacity: 1,
            color: 'rgba(219,128,92,1)',
            dashArray: '',
            lineCap: 'butt',
            lineJoin: 'miter',
            weight: 1,
...
let layer_Mediation_11 = new L.geoJson(json_SPEVBilan2025, {
    attribution: '',
    interactive: true,
    dataVar: 'SPEVBilan2025',
...
let layer_Intervention_12 = new L.geoJson(json_SPEVBilan2025, {
    attribution: '',
    interactive: true,
    dataVar: 'SPEVBilan2025',
...
let layer_Pointsdintervention_14 = new L.geoJson(json_SPEVBilan2025, {
    attribution: '',
    interactive: true,
    dataVar: 'SPEVBilan2025',
...
let layer_StreetAxesSPEV_11 = new L.geoJson(json_StreetAxesSPEV_11, {
    attribution: '',
    interactive: true,
...
// BEGIN >> Eliminar
        ...
        let photonControl = L.control.photon({
            url: url["Nominatim"],
            feedbackLabel: '',
            position: 'topleft',
        ...
        photonControl.on('selected', function (e) {
            ...
            let label = typeof obj2.gcd.properties.label === 'undefined' ? obj2.gcd.properties.display_name : obj2.gcd.properties.label;
        ...
        let search = document.getElementsByClassName("leaflet-photon leaflet-control")[0];
...
let overlaysTree = [
    {
        label: '<b>InterventionsSPEV</b>', children: [
            ...
            { label: '<img src="legend/MoyenneBalayage.png" /> Total Balayage', layer: layer_MoyenneBalayage_10, radioGroup: 'bc' },
...
let lay = L.control.layers.tree(null, overlaysTree, {
    //namedToggle: true,
    //selectorBack: false,
    //closedSymbol: '&#8862; &#x1f5c0;',
    //openedSymbol: '&#8863; &#x1f5c1;',
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function newLayersListHeight() {
        let layerScrollbarElement = document.querySelector('.leaflet-control-layers-scrollbar');
        if (layerScrollbarElement) {
            let layersListElement = document.querySelector('.leaflet-control-layers-list');
            let originalHeight = layersListElement.style.height
                || window.getComputedStyle(layersListElement).height;
            let newHeight = parseFloat(originalHeight) - 50;
            layersListElement.style.height = newHeight + 'px';
        }
    }
    let isLayersListExpanded = true;
    let controlLayersElement = document.querySelector('.leaflet-control-layers');
    let toggleLayerControl = document.querySelector('.leaflet-control-layers-toggle');
    ...
    if (controlLayersElement) {
        controlLayersElement.addEventListener('click', function (event) {
            let toggleLayerHeaderPointer = event.target.closest('.leaflet-layerstree-header-pointer span');
    ...
    resetLabels([layer_Pointsdintervention_14]);
            ...
            let MyControlClass = L.Control.extend({
                ...
                onAdd: function (map) {
                    ...
                    let myButton = L.DomUtil.create('button', 'my-button-class', div);
            ...
            L.easyButton('fa-envelope', function (btn, map) {
                let url = "mailto:proprete@1030.be?subject=Feedback: Actions de propreté publique: (carte SPEV)";
